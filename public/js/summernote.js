...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      variaveis: function (lang) {
        return tplIconButton('fa fa-info-circle icon-question', {
          event: 'showVariaveisDialog',
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      for (var idx = 0, len = options.toolbar.length; idx < len; idx ++) {
        ...
        if (groupName == "variaveis") {
          toolbarHTML += '<div class="note-variaveis modal_variaveis_show btn-group"><button type="button" style="border-left-color: #e6e6e6;" class="btn btn-default btn-sm btn-small" title="" data-hide="true" tabindex="-1">Mostrar Variáveis</button></div>';
        } else {
